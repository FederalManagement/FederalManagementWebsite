...
$h1 = "UK's No.1 choice for Business Debt Collection"; //This is the one on top of the slider
        ...
        <div id="rounded-body">
            <div id="main-content">
            	...
            	<div id="leftColumn">
                	<h1 style="
					color: #CC0000;
					font: 29px 'Calibri';letter-spacing: 0px;"><strong>Business Debt Collection Specialists</strong></h1>
                	<div class="slider">
                    	<ul>
                    ...
                    <div class="text">
                        <p style="color:#1C1F1F;">We are the UK's first choice for Business Debt Collection, recovering millions of pounds for our clients every year.</p>
