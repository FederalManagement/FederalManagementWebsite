...
<meta name="description" content="Federal Management are London's leading debt collection agency." />
<meta name="keywords" content="Debt Collection Agency, Debt Collection, agency, debt, collection, agencies, London" />
<title>Federal Management - The Londons Leading Debt Collection Agency</title>
...
$h1 = "London Debt Collection Specialists"; //This is the one on top of the slider
$h2 = 'Federal Management - London\'s Leading Debt Collection Agency'; //This is the text in the footer
$h3 = 'Expert Debt Collection Agency'; //This is the title for the main list

$alt_logo = 'Federal Management - The London\'s Leading Debt Collection Agency'; //ALT text for the main logo at the header
$alt_main_img = 'The London\'s No1 Debt Collection Agency'; //ALT text for the main page's image
...
$list_item_3 = 'Specialist London Based Collections Teams';
$list_item_4 = 'London Area Debt Enforcement';
