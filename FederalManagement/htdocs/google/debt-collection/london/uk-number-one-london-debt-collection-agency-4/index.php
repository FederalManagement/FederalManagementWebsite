...
$h1 = "No1 UK Specialist Debt Collectors"; //This is the one on top of the slider
$h2 = 'Federal Management - The professionals used by the professionals'; //This is the text in the footer
...
$list_item_1 = 'London\'s Lowest Commission rates starting from 6%';
$list_item_2 = 'Industry leading recovery rates up to 100%';
$list_item_3 = 'No Collection - No Collection Costs to pay';
...
<script src="js/demo.js"></script>
	...
	<div id="outer-wrapper">
    	<div id="social-networks">
        	<iframe src="//www.facebook.com/plugins/like.php?href=http%3A%2F%2Fwww.facebook.com%2FFederalManagement&amp;send=false&amp;layout=button_count&amp;width=450&amp;show_faces=true&amp;action=like&amp;colorscheme=light&amp;font&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:85px; height:21px;background:none;margin:1px 4px -2px 0;"></iframe>
        ...
        <div id="rounded-body">
            <div id="main-content">
            	...
            	<div id="leftColumn">
                	<h1 style="
					color: #CC0000;
					font: 30px 'Calibri';letter-spacing: 0px;"><strong>London Debt Collection Specialists</strong></h1>
                	<div class="slider">
                    	<ul>
                    ...
                    <div class="text">
                        <p style="color:#1C1F1F;">We are London's first choice for Debt Collection services, recovering millions of pounds every year for our clients.</p>
                        ...
                        <p style="color:#1C1F1F;">Complete our quick enquiry form and one of our friendly New Business team will call you straight back with <span style="color:#900;">FREE ADVICE</span> and <span style="color:#900;">ASSISTANCE</span> on how we can help your business today.</p>
        ...
        <div id="footer">
			...
			<strong style="float:left;clear:left;">© <?php $year = getdate(); echo($year['year']);?>. All rights reserved.</strong>
