...
<meta name="description" content="Federal Management are Manchester's leading debt collection agency." />
<meta name="keywords" content="Debt Collection Agency, Debt Collection, agency, debt, collection, agencies, manchester" />
<title>Federal Management - Manchester’s Leading Debt Collection Agency</title>
...
$h1 = "Manchester Debt Collection Specialists"; //This is the one on top of the slider
$h2 = 'Federal Management - Manchester\'s Leading Debt Collection Agency'; //This is the text in the footer
$h3 = 'Expert Debt Collection Agency'; //This is the title for the main list

$alt_logo = 'Federal Management - Manchester\'s Leading Debt Collection Agency'; //ALT text for the main logo at the header
$alt_main_img = 'Manchester\'s No1 Debt Collection Agency'; //ALT text for the main page's image
...
$list_item_3 = 'Specialist Manchester Based Collections Teams';
$list_item_4 = 'Manchester Area Debt Enforcement';
$list_item_5 = 'Millions recovered every year for our clients';
?>
