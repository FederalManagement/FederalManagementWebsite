...
<title>Federal Management - The UK’s Leading International Debt Collectors</title>
...
$h1 = "Specialist UK Debt Collectors"; //This is the one on top of the slider
$h2 = 'Federal Management - The UK’s Leading Debt Collectors'; //This is the text in the footer
$h3 = 'Expert UK Debt Collectors'; //This is the title for the main list

$alt_logo = 'Federal Management - The UK\'s Leading International Debt Collectors'; //ALT text for the main logo at the header
$alt_main_img = 'The UK’s No1 International Debt Collectors'; //ALT text for the main page's image
$alt_call = 'Call us now on 0844 875 4022 for further information on your UK International Debt Collectors requirements.'; //ALT text for the Call Us Now Banner
...
$list_item_5 = 'Outbound Debt Collectors to visit Debtors';
?>
