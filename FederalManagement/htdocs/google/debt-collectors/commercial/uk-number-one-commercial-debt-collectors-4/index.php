        ...
        <div id="rounded-body">
            <div id="main-content">
            	...
            	<div id="leftColumn">
                	<h1 style="
					color: #CC0000;
					font: 26px 'Calibri';letter-spacing: 0px;"><strong>Commercial Debt Collection Specialists</strong></h1>
                	<div class="slider">
                    	<ul>
                    ...
                    <div class="text">
                        <p style="color:#1C1F1F;">We are the UK's first choice for Commercial Debt Collection services, recovering millions of pounds every year for our clients.</p>
