...
$h1 = "UK's No.1 Private Debt Collectors"; //This is the one on top of the slider
$h2 = "Federal Management - The UK's Leading Private Debt Collection Agency"; //This is the text in the footer
$h3 = 'Expert Debt Collection Agency'; //This is the title for the main list

$alt_logo = 'Federal Management - The UK\'s Leading Private Debt Collection Agency'; //ALT text for the main logo at the header
$alt_main_img = 'The UK\'s No1 Private Debt Collection Agency'; //ALT text for the main page's image
$alt_call = 'Call us now on 0800 043 6922 for further information on your debt collection agency requirements.'; //ALT text for the Call Us Now Banner
...
$list_item_1 = 'UK\'s Lowest Commission rates starting from 6%';
$list_item_2 = 'High Recovery Rates up to 87%';
$list_item_3 = '24/7 Online Access to Accounts';
$list_item_4 = 'ISO9001 &amp; Investors in people accredited services';
$list_item_5 = 'Specialised expert Collection officers (internal &amp; external)';
?>
...
<body>
			...
			<script type="text/javascript">
			/* <![CDATA[ */
			var google_conversion_id = 1030873032;
			...
			<img height="1" width="1" style="border-style:none;" alt="" src="//googleads.g.doubleclick.net/pagead/viewthroughconversion/1030873032/?value=0&amp;guid=ON&amp;script=0"/>
			</div>
			</noscript>
...
<script src="js/demo.js"></script>
	...
	<div id="outer-wrapper">
    	<div id="social-networks">
        	<iframe src="//www.facebook.com/plugins/like.php?href=http%3A%2F%2Fwww.facebook.com%2FFederalManagement&amp;send=false&amp;layout=button_count&amp;width=450&amp;show_faces=true&amp;action=like&amp;colorscheme=light&amp;font&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:0px; height:0px;background:none;margin:1px 4px -2px 0;"></iframe>
        ...
        <div id="rounded-body">
            <div id="main-content">
            	<ul class="mini-nav">
                    <li><a href="http://www.federalmanagement.co.uk">Main Website</a></li>
                    <li> | </li>
                    <li><a href="http://youtu.be/o7oa2PnX9GI" target="_blank">Watch our video</a></li>
                    <li> | </li>
                    <li><a href="http://www.federalmanagement.co.uk/corporate/testimonials.php">Testimonials</a></li>
                </ul>
            	<div id="leftColumn">
                	<h1 style="
					color: #CC0000;
					font: 31px 'Calibri';letter-spacing: 0px;"><strong>Private Debt Collection Specialists</strong></h1>
                	<div class="slider">
                    	<ul>
                    ...
                    <div class="text">
                        <p style="color:#1C1F1F;">By simply completing the form to the right our New Business Department will call you to provide <span style="color:#900;">FREE ADVICE</span> on the collection of your outstanding accounts</p>
                        
                    	<p style="color:red;"><strong>Why Federal Management?</strong></p>
                        ...
                        <p style="color:#1C1F1F;">Take the first steps to recovering your money by calling us now on 0800 043 6922 or simply complete the form to the right and a member of our New Business Team will call you back to discuss the matter.</p>
        ...
        <div id="footer">
            <div id="copyright">
			<div id="social-iconss">
			<!-- Trust Pilot -->
			<!-- Trust Pilot -->
			<div class="trustpilot">
			<a href="https://uk.trustpilot.com/review/federalmanagement.co.uk">	<img src="images/interface/trust-pilot.png" alt="Trust Pilot Five Stars" title=""/> </a>
			</div>
            ...
            <div id="associations">
                ...
                <a href="http://www.fca.org.uk/" target="_blank" rel="nofollow"><img src="http://www.federalmanagement.co.uk/images/banners/logo_fca.png" alt="Financial Conduct Authority Website" title="Financial Conduct Authority Website" /></a>
...
<!-- RATING USING MICROFORMATS -->
	...
	<script type="text/javascript" src="https://4e2u.co.uk/2203.js"></script>
</body>
</html>