...
<title>Federal Management - The UK's Leading International Debt Collection Agency</title>
...
$h1 = "Federal Management Provide International Debt Collection on Your Doorstep"; //This is the one on top of the slider
$h2 = 'Federal Management - The UK\'s No.1 for International Debt Collection'; //This is the text in the footer
$h3 = 'Expert Debt Collection Agency'; //This is the title for the main list

$alt_logo = 'Federal Management - The UK\'s Leading International Debt Collection Agency.'; //ALT text for the main logo at the header
$alt_main_img = 'The UK\'s No1 for International Debt Collection.'; //ALT text for the main page's image
$alt_call = 'Call us now on 0844 875 4022 for further information on your international debt collection requirements.'; //ALT text for the Call Us Now Banner
...
$list_item_1 = 'International Collection in Over 83 Countries';
$list_item_2 = 'Multi-Lingual, Local Representatives';
$list_item_3 = 'Millions in International Debt Collected';
$list_item_4 = 'ISO9001 Accredited and CSA Registered';
$list_item_5 = 'Professional Fixed Cost Service';
?>
