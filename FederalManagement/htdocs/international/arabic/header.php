...
<meta name="description" content="<?=$description_arabic;?>" />
<meta name="keywords" content="<?=$keywords_arabic;?>" />
...
<div id="wrapper">
    ...
    <div id="rounded-body">
    	...
    	<div id="header">
        	<div id="logo"><img src="../images/logo.png" alt="<?=$logo_alt_arabic;?>" title="<?=$logo_title_arabic;?>" /></div>
            <div id="title-bar"><p><?=$lang_title_arabic;?></p></div>
        </div><!-- end #header -->