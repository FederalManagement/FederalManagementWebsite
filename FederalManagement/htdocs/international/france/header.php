...
<meta name="description" content="<?=$description_france;?>" />
<meta name="keywords" content="<?=$keywords_france;?>" />
<meta http-equiv="Content-Language" content="fr" />
<title><?=$title_france;?></title>
...
<div id="wrapper">
    ...
    <div id="rounded-body">
    	...
    	<div id="header">
        	<div id="logo"><img src="../images/logo.png" alt="<?=$logo_alt_france;?>" title="<?=$logo_title_france;?>" /></div>
            <div id="title-bar"><p><?=$lang_title_france;?></p></div>
        </div><!-- end #header -->