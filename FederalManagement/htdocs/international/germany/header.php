...
<meta name="description" content="<?=$description_germany;?>" />
<meta name="keywords" content="<?=$keywords_germany;?>" />
<meta http-equiv="Content-Language" content="de" />
<title><?=$title_germany;?></title>
...
<div id="wrapper">
	<div id="social-networks">
        ...
        <!--a href="https://plus.google.com/105240075023583364042?prsrc=3" class="google-plus"><img src="<?=$depth;?>images/interface/google-plus-icon.png" alt="Join us on Google +" title="Join us on Google +" /> <span>Join us</span></a-->
    </div><!-- end #social-networks -->
	<div id="rounded-top"></div>
    <div id="rounded-body">
    
    	<div id="header">
        	<div id="logo"><img src="../images/logo.png" alt="<?=$logo_alt_germany;?>" title="<?=$logo_title_germany;?>" /></div>
            <div id="title-bar"><p><?=$lang_title_germany;?></p></div>
        </div><!-- end #header -->