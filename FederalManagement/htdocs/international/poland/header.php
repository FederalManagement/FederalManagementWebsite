...
<meta name="description" content="<?=$description_poland;?>" />
<meta name="keywords" content="<?=$keywords_poland;?>" />
<meta http-equiv="Content-Language" content="pl" />
<title><?=$title_poland;?></title>
...
<div id="wrapper">
    ...
    <div id="rounded-body">
    	...
    	<div id="header">
        	<div id="logo"><img src="../images/logo.png" alt="<?=$logo_alt_poland;?>" title="<?=$logo_title_poland;?>" /></div>
            <div id="title-bar"><p><?=$lang_title_poland;?></p></div>
        </div><!-- end #header -->