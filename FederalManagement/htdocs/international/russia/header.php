...
<meta name="description" content="<?=$description_russia;?>" />
<meta name="keywords" content="<?=$keywords_russia;?>" />
<meta http-equiv="Content-Language" content="ru" />
<title><?=$title_russia;?></title>
...
<div id="wrapper">
    ...
    <div id="rounded-body">
    	...
    	<div id="header">
        	<div id="logo"><img src="../images/logo.png" alt="<?=$logo_alt_russia;?>" title="<?=$logo_title_russia;?>" /></div>
            <div id="title-bar"><p><?=$lang_title_russia;?></p></div>
        </div><!-- end #header -->