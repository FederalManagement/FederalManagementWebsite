...
<meta name="description" content="<?=$description_spain;?>" />
<meta name="keywords" content="<?=$keywords_spain;?>" />
<meta http-equiv="Content-Language" content="es-es" />
<title><?=$title_spain;?></title>
...
<div id="wrapper">
    ...
    <div id="rounded-body">
    	...
    	<div id="header">
        	<div id="logo"><img src="../images/logo.png" alt="<?=$logo_alt_spain;?>" title="<?=$logo_title_spain;?>" /></div>
            <div id="title-bar"><p><?=$lang_title_spain;?></p></div>
        </div><!-- end #header -->